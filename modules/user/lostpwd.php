...
<div id="lostpassform">
	...
	<form method="post" action="index.php?module=user&action=lostpwd">
		<input type="text" name="txtInput" id="txtInput" />
		
		<input type="submit" class="button" name="sbtForgotPwd" value="Reset Password" />
	</form>
	<?php
		}
	?>
